...
public class HelloOtus {
    ...
    static String getLine(String key, String number) {
        if ((WORDS_99_EN.containsKey(key))&&(null != WORDS_99_EN.get(key))) {
            return upperFirstAtLine(Optional.of(WORDS_99_EN.get(key)).orElse("").replaceAll("%i", number)); // по умолчанию
        }
        return "";
    }
