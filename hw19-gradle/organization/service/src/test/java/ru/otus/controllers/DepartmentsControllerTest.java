...
import ru.otus.controllers.rest.DepartmentsController;
...
class DepartmentsControllerTest {
    private static final Logger log = LoggerFactory.getLogger(DepartmentsControllerTest.class);

    private final static int COUNT = 20;
    private final static String NAME = "name";
    private final static String DESCRIPTION = "Description";

    private final static DepartmentsRequest REQUEST = DepartmentsRequest.builder()
            .name(NAME)
            .description(DESCRIPTION)
            .active(true)
            .build();
    private final static DepartmentsRequest EMPTY_REQUEST = DepartmentsRequest.builder().name("test").build();
