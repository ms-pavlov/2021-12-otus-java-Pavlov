...
import ru.otus.controllers.rest.RoomsController;
...
class RoomsControllerTest {
    private static final Logger log = LoggerFactory.getLogger(RoomsControllerTest.class);

    private final static int COUNT = 20;
    private final static String NAME = "name";
    private final static String DESCRIPTION = "Description";

    private final static RoomsRequest REQUEST = RoomsRequest.builder()
            .name(NAME)
            .description(DESCRIPTION)
            .placementId(1L)
            .active(true)
            .build();
    private final static RoomsRequest EMPTY_REQUEST = RoomsRequest.builder().name("test").placementId(1L).build();
